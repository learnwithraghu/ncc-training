# Lesson 1: Jenkins Docker Setup

This lesson shows how to run Jenkins locally with Docker.

> **Lab note:** If your instructor already provided a Jenkins instance, you can skip this lesson and start with [Lesson 2: Jenkins UI Overview](./02-jenkins-ui-overview.md).
