...
4. Set the name to `GREETING` and the default value to `Hello from Jenkins!`.
5. Click **Save**.
...
[Lesson 15: Build on Push](../topic-15/guide.md) configures automatic builds when code is pushed to Gitea.
