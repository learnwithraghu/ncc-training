# Topic 5: Deployment and Scaling
...
## Goal
Replace the bare Pod from Topic 4 with a Deployment, so a crashed or
deleted Pod gets replaced automatically, and scale it up. This folder is
self-contained: `deployment.yaml` pulls `<ECR_REGISTRY>/orbital-relay:1.0`.
...
5. Cluster networking for the Deployment — **Topic 6: Expose with a Service**.
