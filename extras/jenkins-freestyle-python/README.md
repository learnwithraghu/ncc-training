...
[`07-Jenkins/guided-learning/`](../../07-Jenkins/guided-learning/) and from
[`jenkins-kode-kloud/`](../jenkins-kode-kloud/). It assumes you are working
in **your own lab**, where the infrastructure already exists:
